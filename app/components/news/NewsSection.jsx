    ...
    return (
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="mb-8 text-4xl font-bold text-white md:text-5xl">{title}</h2>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {articles.map((article, index) => (
            <motion.article
              ...
              className="group relative flex flex-col overflow-hidden rounded-xl border border-white/10 bg-zinc-900 transition-transform duration-300 hover:scale-[1.02]"
            >
              {article.urlToImage && (
              ...
              <div className="flex-1 p-6">
                ...
                {article.description && (
                  <p className="line-clamp-3 text-sm text-gray-300">{article.description}</p>
                )}
              </div>
              ...
              <Link
                ...
                className="block border-t border-white/10 p-4 text-center text-sm font-medium text-orange-500 transition-colors hover:bg-white/5"
              >
